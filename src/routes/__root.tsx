...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Petal & Stem — Handcrafted florals for life's moments" },
      { name: "description", content: "A small floral studio designing seasonal, hand-tied bouquets, wedding florals, and custom arrangements. Order online for pickup or delivery." },
      { name: "author", content: "Petal & Stem" },
      { property: "og:title", content: "Petal & Stem — Handcrafted florals" },
      { property: "og:description", content: "Seasonal, hand-tied bouquets and custom arrangements for gifts, weddings, and everyday moments." },
